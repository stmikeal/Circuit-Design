...
HD_PWD='C:/Data/Labs/SchemaTech/lab4/lab4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log de0_cv.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source de0_cv.tcl
